  ...
  return (
    <div>
      ...
      <FadeAnimation>
        <Box
          fontWeight="fontWeightLight"
          sx={{ fontSize: { xs: "12px", sm: "15px" }, paddingBottom: "20px" }}
        >
      ...
      <FadeAnimation>
        ...
        >
          2023年 結成
          <br />
          2023年8月 1st Single 『ordinary』リリース
          <br />
          2024年5月 2nd Single 『未明』リリース
          <br />
          2026年2月 1st Album 『Scrawl』リリース
          <br />
        </Box>
      </FadeAnimation>
      <FadeAnimation>
        <Box
          fontWeight="fontWeightLight"
          sx={{ fontSize: { xs: "15px", sm: "20px" }, padding: "20px 0 5px 0" }}
        >
          Member
        </Box>
      </FadeAnimation>
      ...
      >
        <FadeAnimation>
          <Box sx={{ padding: "3px" }}>Vo.Gt. 伊藤弓月</Box>
        </FadeAnimation>
        <FadeAnimation>
          <Box sx={{ padding: "3px" }}>Gt. 山本健登</Box>
        </FadeAnimation>
        <FadeAnimation>
          <Box sx={{ padding: "3px" }}>Ba. 橋本崇志</Box>
        </FadeAnimation>
        <FadeAnimation>
          <Box sx={{ padding: "3px" }}>Dr. 久保仁</Box>
        </FadeAnimation>
          ...
          <Box sx={{ width: { xs: "60%", sm: "40%" }, marginInline: "auto" }}>
            <li className="icons2" style={{ marginInline: "auto" }}>
              ...
              <IconButton
                ...
                onClick={() => {
                  window.open(
                    "https://music.youtube.com/channel/UCcMl6Fpk77ByOXUXUJSe_gg",
                  );
                }}
                sx={{ aspectRatio: 1, width: { xs: "50px", sm: "15%" } }}
              >
              ...
              <IconButton
                ...
                onClick={() => {
                  window.open(
                    "https://music.line.me/webapp/artist/mi000000001efa2902",
                  );
                }}
                sx={{ aspectRatio: 1, width: { xs: "50px", sm: "15%" } }}
              >
              ...
              <IconButton
                ...
                onClick={() => {
                  window.open(
                    "https://music.amazon.co.jp/artists/B0CG5DZ2BY/bottle-diver",
                  );
                }}
                sx={{ aspectRatio: 1, width: { xs: "50px", sm: "15%" } }}
              >
                <SiAmazonmusic
                  style={{ aspectRatio: 1, width: "100%", marginTop: "3px" }}
                />
              </IconButton>
            </li>
          </Box>
